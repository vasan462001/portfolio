...
export function AboutSection() {
    ...
    "
							>
								...
								<p className="text-lg sm:text-xl lg:text-2xl font-light leading-relaxed sm:leading-loose text-gray-700 dark:text-gray-300">
									...
									building high-quality, cross-platform mobile and web applications with a
    ...
    "
							>
								...
								<div className="space-y-4 text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
									<p>
										My journey began with a comprehensive{" "}
										<strong className="text-blue-700 dark:text-blue-400">
											Python Full-Stack course at QSpiders Training Institute
										</strong>{" "}
										in Chennai, which provided me with a solid foundation in end-to-end development.
									</p>

									<p>
										I enhanced my skills through practical internships as a{" "}
										<strong className="text-indigo-700 dark:text-indigo-400">
											Python Programmer at Encryptix
										</strong>{" "}
										in Delhi and a{" "}
										<strong className="text-indigo-700 dark:text-indigo-400">
											Python Intern at Shiaash Info Solution
										</strong>
										, applying my knowledge to real-world projects and collaborative development.
									</p>
